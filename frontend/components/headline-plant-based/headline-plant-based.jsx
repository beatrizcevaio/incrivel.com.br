...
const HeadlinePlantBased = ({ title, description, selectedPosts, button }) => {
      ...
      <Grid className="container gap-y-4">
        {selectedPosts[0] && (
          <CardPostBig
            ...
            {...selectedPosts[0]}
            columns="col-span-full lg:col-span-6"
            imageClasses="w-full h-[170px] sm:h-[230px] lg:h-[340px]"
            trackingData={{
...
export default HeadlinePlantBased
